...
The session file is missing or expired. Click **Reconnect…** on Telegram in PrivacyFence Settings (or run `privacyfence-app --telegram-setup` from source).

**"Two-step verification required"**
Enter your Telegram cloud password when PrivacyFence Settings prompts for it during sign-in.
